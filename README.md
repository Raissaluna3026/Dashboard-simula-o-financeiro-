...
## 📌 Contexto
Este projeto foi desenvolvido para analisar a rentabilidade financeira por meio do acompanhamento de receitas, custos e margens, permitindo avaliar o desempenho por fornecedor e apoiar decisões estratégicas.
...
- Apoio à tomada de decisão sobre negociação e priorização de fornecedores
